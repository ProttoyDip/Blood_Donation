...
export default function Homepage() {
  ...
  return (
    <div style={{ fontFamily: "Poppins, sans-serif", background: "#fff", minHeight: "100vh", overflowY: "auto" }}>
      {/* Top Bar */}
      <div style={{ background: themeRed, color: "#fff", fontSize: 14, padding: "4px 0", textAlign: "right", paddingRight: 40 }}>
        SMS to 01625524255
      </div>
      {/* Header */}
      <div style={{ background: themeRed, color: "#fff", minHeight: 80 }}>
        <div style={{ maxWidth: 1400, margin: "0 auto", display: "flex", alignItems: "center", height: 80 }}>
          ...
          <div style={{ display: "flex", gap: 30, flex: 1 }}>
            ...
            <Link to="/donors" style={navLinkStyle}>Search Donors</Link>
            <Link to="/add-request" style={navLinkStyle}>Add Blood Request</Link>
            <Link to="/register" style={navLinkStyle}>Register</Link>
            <Link to="/login" style={{ ...navLinkStyle, fontWeight: 700 }}>Login</Link>
          </div>
        </div>
      </div>
      {/* Banner */}
      <div style={{
        ...
        <div style={{ position: "relative", zIndex: 2, maxWidth: 700, margin: "0 auto" }}>
          ...
          <div style={{ display: "flex", justifyContent: "center", gap: 16, alignItems: "center", marginTop: 24 }}>
            ...
            {/* Removed Login and Register navigation */}
          </div>
        </div>
        {/* Wave effect */}
      ...
      <div
        ...
        style={{
          ...
          transform: searchInView ? "translateY(0)" : "translateY(60px)",
      ...
      <div
        ...
        style={{
          ...
          transform: networkInView ? "translateY(0)" : "translateY(60px)",
          transition: "all 0.8s cubic-bezier(.4,1.4,.6,1) 0.3s"
        }}
      >
